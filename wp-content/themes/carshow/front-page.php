...
function be_home_loop() {
    ...
    ?> 
    <div class="events-links-entry"> <div class="entry-header"> <p class="col-1">Events</p> <p class="col-2">Popular Links</p> </div><!-- /entry-header --> <div class="entry-content"> 
            <?php
            ...
            <ul class="col-2"> 
                <?php
                $args = array('limit' => -1, 'title_li' => '', 'category' => 2, 'categorize' => 0);
                wp_list_bookmarks($args);
                ?> 
            </ul> <div class="cl"> </div> </div><!-- /entry-content --> </div><!-- /events-links --> </div><!-- .content-right --> 
            <?php
        }
